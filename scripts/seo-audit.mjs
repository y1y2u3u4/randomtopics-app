...
const checks = [
  ...
  { path: "/question-of-the-day", index: true, canonical: "/question-of-the-day", titleMax: 70, titleHas: "Question of the Day", bodyHas: ["Funny Question of the Day", "100 audience-safe funny prompts", "Copy for group chat", "Plan 5 classroom questions", "Plan 5 team questions"], bodyOccurrences: [{ needle: 'data-qotd-question="true"', exact: 120 }] },
