...
const checks = [
  ...
  { path: "/speech", index: true, canonical: "/speech", titleMax: 60, titleHas: "Speech Topic Generator & Practice Timer", hreflang: true, bodyHas: ["random subject generator", "75 Presentation Topics for School", "120 Toastmasters Table Topics + Practice Drill"] },
