...
const checks = [
  { path: "/es/conversation", index: true, canonical: "/es/conversation", titleHas: "Generador de Temas de Conversación", es: true, bodyHas: ["320 temas disponibles", "Las profundidades sin temas están desactivadas"], bodyNotHas: ["activar la generación con IA", "prácticamente ilimitados"] },
  ...
  { path: "/es/topics/most-likely-to-questions", index: true, canonical: "/es/topics/most-likely-to-questions", titleMax: 65, titleHas: "100 Preguntas de Quién Es Más Probable", es: true, hreflang: true, bodyHas: ["Preguntas fuertes de Quién es más probable para amigos", "Colecciones de Quién es más probable", "Juega a Quién Es Más Probable", "Sacar una pregunta", 'id="generator-es_most_likely_article"', 'href="#generator-es_most_likely_article"', "Filtrar por categoría"], bodyOccurrences: [{ needle: 'class="flex items-start gap-3"', exact: 100 }] },
