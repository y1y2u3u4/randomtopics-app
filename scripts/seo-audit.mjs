...
const checks = [
  ...
  { path: "/question-of-the-day", index: true, canonical: "/question-of-the-day", titleMax: 70, titleHas: "Question of the Day", bodyHas: ["Funny Question of the Day", "100 audience-safe funny prompts", "Copy for group chat", "Plan 5 classroom questions", "Plan 5 team questions", 'id="question-ideas"', 'href="#question-ideas"', ...["classroom", "work", "kids", "deep", "funny"].flatMap((id) => [`id="ideas-${id}"`, `href="#ideas-${id}"`])], bodyOccurrences: [{ needle: 'data-qotd-question="true"', exact: 120 }] },
  ...
  { path: "/es/topics/most-likely-to-questions", index: true, canonical: "/es/topics/most-likely-to-questions", titleMax: 65, titleHas: "100 Preguntas de Quién Es Más Probable", es: true, hreflang: true, bodyHas: ["Preguntas fuertes de Quién es más probable para amigos", "Colecciones de Quién es más probable", "Juega a Quién Es Más Probable", "Preparar ronda", 'id="generator-es_most_likely_article"', 'href="#generator-es_most_likely_article"', "Preguntas por ronda", "Elige una categoría"], bodyOccurrences: [{ needle: 'class="flex items-start gap-3"', exact: 100 }] },
