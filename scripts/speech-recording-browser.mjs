...
const fresh=async()=>{pending.length=0;tracks.length=0;api.calls.length=0;api.hold=false;api.quota=false;recorderStarts=0;events.length=0;await render(true,true)};
