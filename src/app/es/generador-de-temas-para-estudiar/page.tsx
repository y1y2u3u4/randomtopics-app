...
const config = PURPOSE_GENERATORS_ES.study;
...
export const metadata: Metadata = {
  ...
  alternates: {
    ...
    languages: hreflangAlternates("/random-learning-topic-generator"),
  },
  openGraph: {
...
export default function GeneradorTemasParaEstudiarPage() {
