...
const config = PURPOSE_GENERATORS.learning;

export const metadata: Metadata = {
  title: { absolute: config.metaTitle },
  description: config.metaDescription,
  keywords: config.keywords,
  alternates: { canonical: `/${config.slug}`, languages: hreflangAlternates(`/${config.slug}`) },
  openGraph: {
...
export default function RandomLearningTopicGeneratorPage() {
