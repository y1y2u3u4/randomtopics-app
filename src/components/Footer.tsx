  ...
  const tools: { href: string; label: string }[] = [
    ...
    ...(locale === "en"
      ? [
          ...
          { href: "/random-learning-topic-generator", label: "🧠 Learning Topic Generator" },
          { href: "/writing-topic-generator", label: "✍️ Writing Topic Generator" },
          { href: "/research-topic-generator", label: "🔎 Research Topic Generator" },
          { href: "/presentation-topic-generator", label: "📊 Presentation Topic Generator" },
