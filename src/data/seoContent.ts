    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          "Would you rather have the power to undo one decision you made or have the power to see one day into the future?",
          "Would you rather be famous for something embarrassing or be unknown for something incredible?",
          "Would you rather always be overdressed or always be underdressed?",
          "Would you rather have unlimited knowledge but no friends, or average intelligence with a great social circle?",
        ],
      },
    ],
    faq: [
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          "The science of vaccines: how they work, why herd immunity matters, and common misconceptions",
          "How chronic stress affects the immune system and long-term health outcomes",
          "The link between physical activity and academic achievement in students",
          "Understanding eating disorders: causes, warning signs, and paths to recovery",
          "How environmental pollution impacts human health in urban versus rural communities",
        ],
      },
    ],
    faq: [
